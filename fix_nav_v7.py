...
class GlyphBottomNavigationView @JvmOverloads constructor(
    ...
    companion object {
        ...
        // Target a consistent TOTAL height for the bar (interactive + system buttons)
        private const val TARGET_TOTAL_HEIGHT_DP = 95f
    }
    ...
    override fun onApplyWindowInsets(insets: WindowInsets): WindowInsets {
        ...
        // We use the inset as padding to shift content UP above buttons.
        super.setPadding(0, 0, 0, bottomInset)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        // Ensure minimum total height is respected, but keep it compact.
        val totalHeightPx = (TARGET_TOTAL_HEIGHT_DP * density).toInt()
        
        super.onMeasure(widthMeasureSpec, heightMeasureSpec)
        
        // Force the total height. This clips the content area if paddingBottom is large.
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        val density = resources.displayMetrics.density
        // Move icons DOWN by 10dp as requested to close the top gap
        val shiftDownPx = (10f * density).toInt()
        ...
        for (i in 0 until menuView.childCount) {
            ...
            // Apply translation to pull content lower
