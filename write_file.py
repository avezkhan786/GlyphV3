...
content = """package com.glyph.glyph_v3.ui.widgets
...
class GlyphBottomNavigationView @JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        // Force 0 padding in 3rd-party or if any bottom padding exists
        ...
        // Target height: 75dp is a safe compact height that prevents clipping.
        val density = resources.displayMetrics.density
