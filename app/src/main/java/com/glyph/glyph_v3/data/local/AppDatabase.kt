...
@Database(entities = [LocalMessage::class, LocalChat::class, LocalDeletedMessage::class, TranslationCache::class, AiMessage::class, CachedStatus::class, LocalCallLog::class], version = 35, exportSchema = false)
